...
export interface GovernorVotesMockInterface extends utils.Interface {
  functions: {
...
export interface GovernorVotesMock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GovernorVotesMockInterface;
