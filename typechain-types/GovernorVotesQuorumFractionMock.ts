...
export interface GovernorVotesQuorumFractionMockInterface
...
export interface GovernorVotesQuorumFractionMock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GovernorVotesQuorumFractionMockInterface;
